# -*- coding: utf-8 -*-
"""Predictive Maintenance using LSTM.py
...
dataset_train=pd.read_csv('C:\\Users\\ChinthalaSreyaRedd\\Downloads\\archive\\PM_train.txt',sep=' ',header=None).drop([26,27],axis=1)
col_names = ['id','cycle','setting1','setting2','setting3','s1','s2','s3','s4','s5','s6','s7','s8','s9','s10','s11','s12','s13','s14','s15','s16','s17','s18','s19','s20','s21']
dataset_train.columns=col_names
print('Shape of Train dataset: ',dataset_train.shape)
dataset_train.head()

dataset_test=pd.read_csv('C:\\Users\\ChinthalaSreyaRedd\\Downloads\\archive\\PM_test.txt',sep=' ',header=None).drop([26,27],axis=1)
dataset_test.columns=col_names
print('Shape of Test dataset: ',dataset_train.shape)
dataset_train.head()

pm_truth=pd.read_csv('C:\\Users\\ChinthalaSreyaRedd\\Downloads\\archive\\PM_truth.txt',sep=' ',header=None).drop([1],axis=1)
pm_truth.columns=['more']
pm_truth['id']=pm_truth.index+1
pm_truth.head()

"""Generating the Column Max for the test data"""
...
"""Reshaping the Dataset to fit the LSTM (Function)"""
...
"""Probability for Machine Failure"""
